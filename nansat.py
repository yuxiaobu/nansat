    ...
    * and much more...
    ...
    def resize(self, factor=1, width=None, height=None, eResampleAlg=-1):
                ...
                for iNode2 in iNode1.nodeList(sourceName):
                    ...
                    if 'ScaleRatio' in iNode2.tagList():
                        if iNode2.node('ScaleRatio').value != '1':
                            scaleRatio = True
            for iNode2 in iNode1.node('Metadata').nodeList('MDI'):
                if iNode2.getAttribute('key') == '_FillValue':
                    fillValue = True
        ...
        if eResampleAlg == -1 and (scaleRatio or complexValue):
            ...
            if eResampleAlg == -1 and fillValue:
                print 'NaN values might be replaced to 0. in resize()'
